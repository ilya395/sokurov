...
function sokurov_wp_media() {
    wp_enqueue_style('vendors_style', get_template_directory_uri() . '/dist/css/vendors~main.01b6f093e9d10520f253.css', [], null, false);
	wp_enqueue_style('main_style', get_template_directory_uri() . '/dist/css/main.01b6f093e9d10520f253.css', [], null, false);
	...
	wp_enqueue_script('vendors_script', get_template_directory_uri() . '/dist/js/vendors~main.01b6f093e9d10520f253.js', ['jq', 'api2gis'], null, true);
	wp_enqueue_script('main_script', get_template_directory_uri() . '/dist/js/main.01b6f093e9d10520f253.js', ['jq', 'api2gis'], null, true);
